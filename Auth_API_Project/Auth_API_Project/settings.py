"""
Django settings for Auth_API_Project project.
...
SECRET_KEY = 'django-insecure-wdfp^5$yxh49*-(rk-e8fs#%2w5a4=-#1g^*20!i3qo8w@!2r^'
...
ROOT_URLCONF = 'Auth_API_Project.urls'
...
WSGI_APPLICATION = 'Auth_API_Project.wsgi.application'
